...
public class ProductExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ProblemDetail handleProductServiceException(ProductServiceException ex, WebRequest request) {
        log.error("Intercepted ProductServiceException. Message: {}. Status: {}", ex.getMessage(), ex.getStatus());
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        return ResponseEntity
                .badRequest()
                .body(createProblemDetail(ex.getMessage(), HttpStatus.BAD_REQUEST, request));
    }
