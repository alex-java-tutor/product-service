...
public class TestConstants {
    ...
    public static final BigDecimal PRODUCT_ONE_PRICE = BigDecimal.valueOf(11);
    public static final BigDecimal PRODUCT_TWO_PRICE = BigDecimal.valueOf(12);
    public static final BigDecimal PRODUCT_THREE_PRICE = BigDecimal.valueOf(13);
    public static final BigDecimal PRODUCT_FOUR_PRICE = BigDecimal.valueOf(14);
    public static final BigDecimal PRODUCT_FIVE_PRICE = BigDecimal.valueOf(15);
    public static final BigDecimal NEW_PRODUCT_PRICE = BigDecimal.valueOf(16);
